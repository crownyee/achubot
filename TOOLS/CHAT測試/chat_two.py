...
streamer = 'UC1DCedRgGHBdm81E1llLhOQ'
...
class FW_Chat(Cog_Extension):
    def __init__(self, *args, **kwargs):
        ...
        self.msg_queue = deque(maxlen=90000)
        async def holo_chat():
            ...
            while not self.bot.is_closed():
                ...
                try:
                    ...
                    fwmc_id = 'gxZYeXU5Dek'
                    live_time = '2024-01-31T16:00:00.000Z'
